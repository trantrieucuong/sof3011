...
<body>
<form class="row g-3" action="/mausac/update?id=${ms.id}" method="post">
    <div class="col-md-6">
        <label for="id" class="form-label">Mã Màu</label>
        <input type="text" class="form-control" id="id" name="ma" value="${ms.maMau}">
    </div>
    <div class="col-md-6">
        <label for="name" class="form-label">Tên Màu</label>
        <input type="text" class="form-control" id="name" name="ten" value="${ms.tenMau}">
    </div>
    <div class="col-md-6">
